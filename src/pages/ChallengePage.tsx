      ...
      default:
        return (
          <form onSubmit={handleTextSubmit} className="space-y-3">
            <label
              htmlFor="answer"
              className="block text-body font-semibold text-gray-900 mb-3"
            >
              Your Answer
            </label>
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-md focus:border-blue-600 focus:outline-none transition-colors font-mono bg-white text-gray-900"
                disabled={submitting}
              />
              <button
                type="submit"
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto py-8">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Challenge Header */}
          <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-md mb-6">
            <div className="flex items-center justify-between mb-4">
              <h1 className="text-h2 font-bold text-gray-900">
                Stage {stage.stage_number}: {stage.title}
              </h1>
              <div className="bg-blue-100 text-blue-600 px-4 py-2 rounded-full text-body font-semibold">
                {stage.points} pts
              </div>
            </div>
            <p className="text-body text-gray-600">{stage.description}</p>
            {hints.length > 0 && (
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="hint-button w-full px-4 py-3 flex items-center justify-between bg-gray-50 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-600"
                        style={{
                          display: "flex",
                          visibility: "visible",
                          opacity: 1,
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-small text-yellow-700 font-medium bg-yellow-100 px-2 py-1 rounded">
