    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto py-16">
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md border border-gray-200">
          <h1 className="text-h2 font-bold text-gray-900 mb-2 text-center">Create Account</h1>
          <p className="text-body text-gray-600 mb-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="username" className="block text-body font-medium text-gray-900 mb-2">
                Username
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-300 rounded-md focus:border-blue-600 focus:outline-none transition-colors text-gray-900 placeholder:text-gray-500"
                  placeholder="johndoe"
                />
              </div>
            </div>
            ...
            <div>
              <label htmlFor="password" className="block text-body font-medium text-gray-900 mb-2">
                Password
              </label>
              <div className="relative">
              ...
              <p className="mt-2 text-small text-gray-600">At least 6 characters</p>
            </div>
